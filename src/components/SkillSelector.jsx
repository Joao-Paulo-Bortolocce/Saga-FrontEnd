...
import { Search, CheckSquare, X, Filter, Book } from 'lucide-react';
...
const SkillSelector = ({ 
  ...
  const isSkillSelected = (skill) => {
    return selectedSkills.some(s => s.cod === skill.cod);
  };
    ...
    <div>
      ...
      <div className="mb-3">
        <Button 
          ...
          variant={selectedSkills.length > 0 ? 'primary' : 'outline'}
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="relative">
              ...
              <div className="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg z-10 border border-gray-200 p-3 hidden group-focus:block">
            ...
            <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
              {Object.entries(skillsBySubject).map(([subject, subjectSkills]) => (
                <div key={subject} className="space-y-2">
                  <div className={`flex items-center gap-2 ${getSubjectColor(subject)} px-3 py-2 rounded-md`}>
                    <Book size={18} />
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start">
                            <div className={`p-2 rounded-md mr-3 ${isSelected ? 'bg-blue-200' : 'bg-gray-100'}`}>
                              <CheckSquare 
                                size={18} 
          ...
          <div className="flex justify-between mt-4 pt-3 border-t">
            ...
            <Button
              ...
              onClick={() => setIsModalOpen(false)}
            >
              Confirmar ({selectedSkills.length})
            </Button>
          </div>
        </div>
      </Modal>
